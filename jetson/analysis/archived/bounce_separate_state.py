# analysis/archived/bounce_separate_state.py

"""
Archived split-state bounce detector for the analysis pipeline.

This was the active implementation before bounce state moved into ball.py to
match the original tracker.py update order. It is retained for reference only.
