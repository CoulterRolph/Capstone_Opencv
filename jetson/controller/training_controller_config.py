...
MIN_BALL_SPEED = 55
MAX_BALL_SPEED = 100
DEFAULT_BALL_SPEED = 75

MIN_PACE_SECONDS = 0.1
MAX_PACE_SECONDS = 60.0
DEFAULT_PACE_SECONDS = 1.5

MIN_START_DELAY_SECONDS = 0.0
MAX_START_DELAY_SECONDS = 15.0
DEFAULT_START_DELAY_SECONDS = 0.0
START_DELAY_INCREMENT_SECONDS = 0.5
...
STATUS_START_DELAY_CANCELLED = "Training start delay cancelled."
